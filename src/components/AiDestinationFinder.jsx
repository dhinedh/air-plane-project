              ...
              <div className="p-8 md:p-12">
                <AnimatePresence mode="wait">
                  ...
                  {loading && (
                    ...
                    >
                      <div className="w-16 h-16 rounded-2xl bg-amber-400 flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(251,191,36,0.4)]">
                  ...
                  {error && (
                    ...
                    >
                      ...
                      <button onClick={reset} className="mt-6 inline-flex items-center gap-2 bg-amber-400 hover:bg-amber-300 text-[#060d1a] font-black px-6 py-3 rounded-xl transition-all">
                  ...
                  {result && (
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        <a href="/contact" className="flex-1 text-center bg-amber-400 hover:bg-amber-300 text-[#060d1a] font-black py-3.5 rounded-xl transition-all shadow-[0_0_20px_rgba(251,191,36,0.3)]">
                          Book These Packages →
                        </a>
