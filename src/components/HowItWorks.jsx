  ...
  <section className="py-28 bg-[#060d1a] relative overflow-hidden">
    ...
    <div className="container mx-auto px-6 lg:px-16 relative z-10">
        ...
        {steps.map((step, i) => (
          <motion.div key={i} variants={fadeUp} className="relative z-10 group">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 rounded-2xl bg-amber-400/10 border border-amber-400/30 flex items-center justify-center text-amber-400 group-hover:bg-amber-400 group-hover:text-[#060d1a] transition-all duration-400 relative z-10">
                {step.icon}
              </div>
      ...
      >
        <Link
          to="/contact"
          className="group inline-flex items-center gap-3 bg-amber-400 hover:bg-amber-300 text-[#060d1a] font-black text-lg px-12 py-4 rounded-full transition-all shadow-[0_0_40px_rgba(251,191,36,0.3)] hover:shadow-[0_0_60px_rgba(251,191,36,0.5)]"
        >
