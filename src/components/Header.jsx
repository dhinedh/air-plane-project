    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50">
        ...
        <motion.div
          ...
          className="overflow-hidden bg-slate-100 border-b border-gray-200"
        >
          <div className="container mx-auto px-6 lg:px-12 h-[36px] flex items-center justify-between">
            <div className="flex items-center gap-6 text-[10px] font-bold tracking-widest uppercase text-gray-500">
            ...
            <a href="tel:+919600213XXX" className="flex items-center gap-1.5 text-[10px] font-bold tracking-widest uppercase text-gray-500 hover:text-sky-500 transition-colors">
          ...
          <div className="container mx-auto px-6 lg:px-12">
            <div className="flex items-center justify-between h-16 md:h-[72px]">
                    ...
                    >
                      ...
                      {isActive ? (
                        <motion.span
                          ...
                          className="absolute bottom-0 left-4 xl:left-5 right-4 xl:right-5 h-[2px] rounded-full bg-sky-500"
                          transition={{ type: 'spring', stiffness: 380, damping: 30 }}
                        />
                      ) : (
                        <span className="absolute bottom-0 left-4 xl:left-5 right-4 xl:right-5 h-[2px] rounded-full bg-transparent group-hover:bg-gray-300 transition-colors" />
                      )}
                    </Link>
                  );
                })}
              ...
              <div className="hidden lg:flex items-center gap-4 shrink-0">
                ...
                <Link
                  to="/contact"
                  className="relative overflow-hidden group flex items-center gap-2 bg-sky-500 hover:bg-sky-400 text-white font-black text-[11px] uppercase tracking-[0.15em] px-7 py-3 rounded-lg transition-all shadow-[0_0_20px_rgba(56,189,248,0.25)] hover:shadow-[0_0_35px_rgba(56,189,248,0.5)]"
                >
              ...
              {/* Mobile Toggle */}
              <button
                className="lg:hidden p-2.5 rounded-lg bg-gray-100 border border-gray-200 text-gray-700 hover:bg-gray-200 transition-colors"
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 z-[50] w-full max-w-[320px] bg-white border-l border-gray-200 shadow-2xl flex flex-col"
            >
              {/* Drawer Header */}
              <div className="flex items-center justify-between px-6 py-5 border-b border-gray-200">
                <div>
                  <p className="font-black text-lg tracking-[0.12em] text-gray-900">DCRUISE</p>
                  <p className="text-[8px] font-bold tracking-widest uppercase text-sky-500 mt-0.5">Platinum Edition</p>
                </div>
                <button
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="p-2 rounded-lg bg-gray-100 border border-gray-200 text-gray-500 hover:text-gray-700"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              {/* Drawer Footer */}
              <div className="px-6 pb-8 pt-4 border-t border-gray-200 space-y-3">
                <a href="tel:+919600213XXX" className="flex items-center gap-3 py-3 px-4 rounded-xl bg-gray-50 border border-gray-200 text-gray-600 hover:text-gray-900 hover:border-gray-300 transition-all group">
                  ...
                  <div>
                    <p className="text-[9px] font-bold tracking-widest uppercase text-gray-400">Call Us</p>
                    <p className="text-sm font-bold tracking-wide text-gray-800">+91 9600213XXX</p>
                  </div>
                </a>
                <Link
                  to="/contact"
                  className="flex items-center justify-between w-full bg-sky-500 text-white font-black text-sm uppercase tracking-[0.15em] rounded-xl px-5 py-4 hover:bg-sky-400 shadow-[0_0_20px_rgba(56,189,248,0.3)] transition-all"
                >
