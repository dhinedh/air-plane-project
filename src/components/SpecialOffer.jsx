...
const SpecialOffer = () => (
  <section className="py-6 px-6 lg:px-16 bg-brand-primary">
    <motion.div
      initial="hidden"
      whileInView="visible"
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/98 via-brand-primary/80 to-brand-primary/60"></div>
      ...
      <div className="relative z-10 py-20 px-10 md:px-20 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="max-w-xl">
          <span className="inline-block bg-brand-accent text-brand-primary text-xs font-black uppercase tracking-widest px-4 py-1.5 rounded-full mb-6">
            🎉 Limited Time Offer
          </span>
          <h2 className="text-4xl md:text-6xl font-black text-white leading-tight mb-5">
            Plan Your <span className="text-amber-400">Dream Trip</span><br className="hidden md:block" /> Today — Save Up to 25%
          </h2>
        ...
        <div className="bg-white/6 backdrop-blur-xl border border-white/10 rounded-2xl p-8 w-full max-w-sm flex-shrink-0">
          ...
          <div className="space-y-4">
            <a href="tel:+919600213XXX" className="flex items-center gap-4 group bg-amber-400/10 hover:bg-amber-400 border border-amber-400/20 hover:border-amber-400 rounded-xl px-5 py-4 transition-all duration-300">
              <div className="w-10 h-10 rounded-lg bg-brand-accent group-hover:bg-brand-primary flex items-center justify-center flex-shrink-0 transition-colors">
                <Phone className="w-5 h-5 text-brand-primary group-hover:text-amber-400" />
              </div>
              <div>
                <p className="text-amber-400 group-hover:text-brand-primary font-black transition-colors text-sm">Call Us Now</p>
                <p className="text-white/60 group-hover:text-brand-primary/70 text-xs transition-colors">+91 9600213XXX</p>
              </div>
            </a>
            ...
            <a href="mailto:info@dcruise.com" className="flex items-center gap-4 group bg-white/4 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-xl px-5 py-4 transition-all duration-300">
              <div className="w-10 h-10 rounded-lg bg-white/10 group-hover:bg-amber-400/20 flex items-center justify-center flex-shrink-0 transition-colors">
                <Mail className="w-5 h-5 text-white/60 group-hover:text-amber-400 transition-colors" />
              </div>
              <div>
            ...
            <Link
              to="/contact"
              className="block text-center bg-brand-accent hover:bg-amber-300 text-brand-primary font-black text-sm px-6 py-4 rounded-xl transition-all shadow-[0_0_20px_rgba(251,191,36,0.3)] hover:shadow-[0_0_35px_rgba(251,191,36,0.5)]"
            >
              Fill Enquiry Form →
            </Link>
          </div>
